...
class DashboardPostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        //if image kosong, ambil dari API address
    ...
    public function update(Request $request, Post $post)
    {
        ...
        //cek slug untuk buat perbarui slug sebagai slug baru 
        ...
        //update validate, where id=id
        Post::where('id', $post->id)
                ->update($validatedData);

        return redirect('/dashboard/posts')->with('success', 'Project has been edited!');
