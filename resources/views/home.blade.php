...
<div class="text-center d-flex flex-column align-items-center">
    <div class="header-title">
        ...
        <br class="d-none d-md-block"> Bersama Developer Lainnya</h1>
    </div>
</div>
      ...
      <div class="text-left col-lg-6 col-12">
        <div class="mb-20">
          <div class="front-text-group">
            ...
            <h2 class="header-primary mb-0">Lorem ipsum dolor, sit amet <br> Lorem ipsum dolor sit amet.</h2>
            <p class="text-support text-green mt-2">Lorem ipsum, dolor sit amet consectetur <br>
            adipisicing elit. Excepturi recusandae minima iste, blanditiis, assumenda cupiditate<br> rem harum nam repellat adipisci inventore neque accusantium possimus quaerat.</p>
    ...
    <div class="col">
      <div class="card p-2 border-0">
        <div class="card-body">
          ...
          <a href="https://roadmap.sh/frontend" target="_blank" class="btn btn-primary stretched-link"> > </a>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card p-2 border-0">
        <div class="card-body">
          ...
          <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <a href="https://roadmap.sh/backend" target="_blank" class="btn btn-primary stretched-link"> > </a>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card p-2  border-0">
        <div class="card-body">
          ...
          <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <a href="https://roadmap.sh/react" target="_blank" class="btn btn-primary stretched-link"> > </a>
        </div>
      </div>
    </div>
    ...
    <div class="col">
      <div class="card p-2 border-0">
        <div class="card-body">
          ...
          <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <a href="https://roadmap.sh/android" target="_blank" class="btn btn-primary stretched-link"> > </a>
        </div>
      </div>
    </div>
  </div>
